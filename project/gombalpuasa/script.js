...
function fungsimau(){Tombol.style="opacity:0";kalimat.style = "opacity:0;transition:all .6s ease";setTimeout(function(){kalimat.innerHTML = kataditerima;kalimat.style = "opacity:1;transform:scale(1.2);transition:all .6s ease;margin-bottom:20px;";Tombol.style="display:none";setTimeout(ngetik2,700);},500);}
...
function ngetik2() {
  ...
  function kemunculan3(){otomatis();kalimatc.innerHTML = katangetik2;setTimeout(kemunculan,2000);}
       ...
       async function jawab(){await swals.fire('Kirim pesan ke WhatsApp aku, ya!');window.location = "https://api.whatsapp.com/send?phone=6281559519325&text=" + pesanwhatsapp;}